...
static void lu5_register_constants(lua_State *L) 
{
	...
	LUA_ADD_NUMBER_GLOBAL_BY_NAME(L, "POINTS"        , GL_POINTS);
	LUA_ADD_NUMBER_GLOBAL_BY_NAME(L, "QUADS"         , GL_QUADS);
	LUA_ADD_NUMBER_GLOBAL_BY_NAME(L, "LINES"         , GL_LINES);
	LUA_ADD_NUMBER_GLOBAL_BY_NAME(L, "LINE_STRIP"    , GL_LINE_STRIP);
	LUA_ADD_NUMBER_GLOBAL_BY_NAME(L, "LINE_LOOP"     , GL_LINE_LOOP);
	LUA_ADD_NUMBER_GLOBAL_BY_NAME(L, "TRIANGLES"     , GL_TRIANGLES);
	LUA_ADD_NUMBER_GLOBAL_BY_NAME(L, "TRIANGLE_STRIP", GL_TRIANGLE_STRIP);
	LUA_ADD_NUMBER_GLOBAL_BY_NAME(L, "TRIANGLE_FAN"  , GL_TRIANGLE_FAN);
	LUA_ADD_NUMBER_GLOBAL_BY_NAME(L, "QUAD_STRIP"    , GL_QUAD_STRIP);
