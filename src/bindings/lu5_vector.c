...
static int lu5_vector_mult(lua_State *L) {
...
static int lu5_vector_add(lua_State *L) {
...
static int lu5_vector_new(lua_State *L) {
...
int lu5_bind_vector(lua_State *L) {
    ...
    lua_pushcfunction(L, lu5_vector_new);
    lua_setglobal(L, "createVector");

	// Push class to global state
